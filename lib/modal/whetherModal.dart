...
/// base : "stations"
/// main : {"temp":303.14,"feels_like":310.14,"temp_min":303.14,"temp_max":303.14,"pressure":1008,"humidity":79}
/// visibility : 6000
/// wind : {"speed":4.12,"deg":210}
/// clouds : {"all":35}
/// dt : 1666093272
/// sys : {"type":1,"id":9071,"country":"IN","sunrise":1666055100,"sunset":1666096947}
/// timezone : 19800
/// id : 1255364
/// name : "Surat"
/// cod : 200
...
class WhetherModal {
  ...
  WhetherModal.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WhetherModal copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WhetherModal(  coord: coord ?? _coord,
